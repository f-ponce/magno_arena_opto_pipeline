...
def plot_ma081621_test_trials_saccs(velos, velos1, ovelos, reg_t, test_trials, start_frames, end_frames, all_saccs_l_idx, all_saccs_r_idx, pattern_velos, datapath, savemyfig, flynumber):
    # savefigdir = '/Users/fponce/Documents/magno_arena_opto/analysis_MA_2022/pickled_data/MA_081621_10s_figs/'
    # exp = 'MA_081621_10s'
    ...
    for i in range(len(test_trials)):
        ...
        all_saccs_l_idx
        sl = reg_t[~np.isnan(all_saccs_l_idx[s:e])]
        sr = reg_t[~np.isnan(all_saccs_r_idx[s:e])]
        axs.eventplot(sl, color='r', linelengths = 0.4)
        axs.eventplot(sr, color='r', linelengths = 0.4)
